...
export function EvidenceMaturity() {
  return (
    <div>
      ...
      <p className="site-muted mt-3 text-sm leading-6">Historical baseline snapshot for this evidence pipeline. These maturity counts do not describe the separate ASTRA independent risk assessment.</p>
