  ...
  return <PageShell><div className="folio">
    <section className="folio-hero home-hero folio-wrap" aria-labelledby="portfolio-title">
      <div className="folio-hero-main">
        <p className="folio-eyebrow">meanydeany / Independent work</p>
      ...
      <aside className="folio-margin" aria-label="Background and current focus">
        ...
        <dl><dt>Master&apos;s</dt><dd>MSc Economics<br />University of Copenhagen</dd><dt>Undergraduate</dt><dd>Quantitative Economics &amp; Econometrics<br />UC San Diego</dd><dt>Based in</dt><dd>Seoul, South Korea</dd></dl>
    ...
    <section className="folio-wrap folio-section folio-about-grid" aria-labelledby="working-method-title">
      <div><p className="folio-eyebrow">How I work</p><h2 id="working-method-title">One researcher.<br />A connected body of work.</h2><p className="folio-lead">My academic training spans undergraduate Quantitative Economics &amp; Econometrics at UC San Diego and an MSc in Economics at the University of Copenhagen. Trading gives me questions; research helps me test them; engineering makes those tests repeatable.</p></div>
    ...
    <section className="folio-wrap folio-contact"><div><p className="folio-eyebrow">Get in touch</p><h2>Let’s talk about markets<br />and the systems behind them.</h2></div><div className="folio-links"><Link className="folio-primary" href="/contact">Contact meanydeany ↗</Link><Link href="/resume">Résumé ↗</Link><a href="https://github.com/MeanyDeany" target="_blank" rel="noreferrer">GitHub ↗</a></div></section>
  </div></PageShell>;
}
