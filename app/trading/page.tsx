...
export default function TradingPage() {
  return <PageShell><div className="folio">
    <PortfolioIntro eyebrow="Woosub Shin / Personal trading" title="The trading record."><p>My account outcomes, not a strategy advertisement. Positions, published returns, and daily history are shown with their source and reporting limits.</p></PortfolioIntro>
