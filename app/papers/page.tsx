...
export const metadata = metadataFor("/papers", "Academic Papers", "Original MSc and seminar papers, their research questions and methods, and how they connect to meanydeany’s current trading and market research.");

export default function PapersPage() {
  return <PageShell><div className="folio"><PortfolioIntro eyebrow="meanydeany / Academic work" title="The academic foundation."><p>Two papers in financial econometrics and Bitcoin price dynamics. Each is a starting point for the questions I now study in futures markets, not a claim about today’s account performance.</p></PortfolioIntro><section className="folio-wrap" aria-label="Academic papers">
